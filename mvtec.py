...
CLASS_NAMES = ['chip', 'bottle', 'cable', 'capsule', 'carpet', 'grid',
...
class MVTecDataset(Dataset):
    def __init__(self, dataset_path='D:/dataset/mvtec_anomaly_detection', class_name='bottle', is_train=True,
                 resize=292, centerCrop=256, randomCrop=282, randomRotation=2):
        ...
        self.transform_mask = T.Compose([T.RandomRotation(degrees=(-randomRotation, randomRotation)),
    ...
    def __getitem__(self, idx):
        ...
        if y == 0:
            mask = torch.zeros([1, self.centerCrop, self.centerCrop])
        else:
